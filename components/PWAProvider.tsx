...
export function PWAProvider() {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 md:left-auto md:right-6 md:w-80 z-50 print:hidden space-y-3">
      {showUpdateBanner && (
        <div className="bg-emerald-700 rounded-2xl p-4 shadow-2xl border-2 border-emerald-600 flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-emerald-100 text-xs font-medium mt-0.5 leading-relaxed">
              A new version is ready. Refresh to update now.
            </p>
            <button
              onClick={handleUpdate}
              className="mt-3 bg-white text-emerald-800 px-4 py-2 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-emerald-50 transition-all"
            >
              Refresh App
            </button>
          </div>
